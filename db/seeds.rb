...
Education.create(start_date: "2005-06-23", end_date: "2010-8-12", degree: "Bachelor of Arts", university_name: "University of Texas", details: "Real-time; strategize webservices leverage action-items synergies widgets enable generate. Integrate ad delivery harness design extend remix enhance cross-media. Granular, extend weblogs, integrate; sexy expedite e-business drive markets interactive", student_id: 1)

Education.create(start_date: "2003-03-14", end_date: "2011-4-28", degree: "Bachelor of Science", university_name: "University of South Dakota", details: "Real-time; strategize webservices leverage action-items synergies widgets enable generate. Integrate ad delivery harness design extend remix enhance cross-media. Granular, extend weblogs, integrate; sexy expedite e-business drive markets interactive", student_id: 2)

Education.create(start_date: "2014-10-17", end_date: "2018-2-3", degree: "Bachelor of Science", university_name: "Miami University", details: "Real-time; strategize webservices leverage action-items synergies widgets enable generate. Integrate ad delivery harness design extend remix enhance cross-media. Granular, extend weblogs, integrate; sexy expedite e-business drive markets interactive", student_id: 3)
